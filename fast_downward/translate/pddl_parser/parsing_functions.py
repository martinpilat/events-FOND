...
def parse_task(domain_pddl, task_pddl):
    domain_name, domain_requirements, types, type_dict, constants, predicates, predicate_dict, functions, actions, axioms, events \
    ...
    return pddl.Task(
        ...
        predicates, functions, init, goal, actions, axioms, use_metric, events)
